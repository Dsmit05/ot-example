...
import (
	...
	"github.com/Dsmit05/ot-example/service-write/internal/broker/rmq"
...
func main() {
	log.Println("service-write with rmq start")
	...
	br, err := rmq.NewConsumer("amqp://guest:guest@localhost:5672/", "msgs", db)
	if err != nil {
		log.Fatal(err)
	}
